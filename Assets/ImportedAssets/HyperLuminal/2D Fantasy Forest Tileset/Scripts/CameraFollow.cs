...
public class CameraFollow : MonoBehaviour 
{
	...
	private void MoveCamera(float timeDelta)
    {
		...
		if (CheckXMargin())
		{
			...
			target.x = Mathf.Lerp(transform.position.x, PlayerTransform.position.x, cameraSpeed * timeDelta);
		}
		...
		if (CheckYMargin())
		{
			...
			target.y = Mathf.Lerp(transform.position.y, PlayerTransform.position.y, cameraSpeed * timeDelta);
		}
